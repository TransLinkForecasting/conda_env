...
conda install -y -n asim1_2 -c conda-forge --override-channels mord=0.6 pylogit=1.0.1 contextily folium branca cycler kiwisolver
# choice models
...
# tlpytools latest
pip install tlpytools==0.1.6 --upgrade
pip install --upgrade "sqlalchemy<2.0"
# ipython kernel
ipython kernel install --user --name=asim1_2
# pip install jupyter_contrib_nbextensions
# export environment
conda env export -n asim1_2 -f asim1_2.yml --no-builds
# # install activitysim
...
pip install git+https://github.com/TransLinkForecasting/populationsim@td_2023 --upgrade
# install geopandas and its dependencies
pip install pyogrio geopandas==0.11.1
# precompiled wheel files (deprecated)
